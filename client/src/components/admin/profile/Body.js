...
return (
  <div className="flex-[0.8] mt-0"> {/* Changed mt-3 to mt-0 */}
    <div className="space-y-5 h-full">
      ...
      <div className="w-full bg-gray-200 relative rounded-xl border-none"> {/* Changed w-[100%] to w-full and removed border classes */}
