...
const Sidebar = () => {
  ...
  // }, []);
  return (
    <div className="flex-[0.2] h-screen flex flex-col justify-between" style={{marginBottom: '77px', marginRight:'47px'}}>
      <div className=" space-y-8 overflow-y-scroll scrollbar-thin scrollbar-track-white scrollbar-thumb-black-300 ">
        <div className="">
          <NavLink
            to="/admin/home"
            className={({ isActive }) =>
          ...
          <NavLink
           ...
           <NavLink
            ...
            <AddIcon className="" />
            <h1 className="font-normal">Add alert</h1>
          </NavLink>
          <hr></hr>
        </div>
        <div className="">
        ...
        <div className="">
          ...
          <NavLink
            ...
            <AddIcon className="" />
            <h1 className="font-normal">Add Company</h1>
          </NavLink>
          <NavLink
            to="/admin/deleteCompany"
            className={({ isActive }) =>
              isActive ? isActiveStyle : isNotActiveStyle
            }>
            <DeleteIcon className="" />
            <h1 className="font-normal">Delete Company</h1>
          </NavLink>
