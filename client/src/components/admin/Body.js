    ...
    <div className="flex-[0.9] mt-3">
      ...
      <div className="space-y-5">
        ...
        <div className="flex flex-col mr-5 space-y-4 overflow-y-hidden">
          ...
          <div className="fixed bottom-0 left-0 w-full text-white bg-black h-16  shadow-lg grid grid-cols-4 justify-between px-8 items-center space-x-4">
